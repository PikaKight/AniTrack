...
"")
        ...
        self.addanime = QtWidgets.QPushButton(self.centralwidget)
        self.addanime.setGeometry(QtCore.QRect(300, 20, 241, 81))
        font = QtGui.QFont()
        font.setFamily("Gabriola")
        font.setPointSize(20)
        self.addanime.setFont(font)
        self.addanime.setStyleSheet("background-color: rgb(82, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.anime.setText(_translate("MainWindow", list(back.Anime().view_all())[0]))
        self.addanime.setText(_translate("MainWindow", "Add Anime"))
